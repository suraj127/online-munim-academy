...
export default function HomePage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#040814] overflow-hidden">
      ...
      {/* Featured Video (Netflix Style Banner) */}
      {featuredVideo && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
          ...
          >
            ...
            <div className="relative z-10 space-y-4 max-w-2xl text-left">
              ...
              <h2 className="text-2xl md:text-4xl font-bold font-display text-white group-hover:text-accent transition-colors duration-300">
                {featuredVideo.title}
              </h2>
              <p className="text-zinc-300 text-sm md:text-base line-clamp-3 md:line-clamp-2">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white text-zinc-950 font-semibold hover:bg-accent hover:text-zinc-950 shadow-lg transition-all duration-300"
              >
