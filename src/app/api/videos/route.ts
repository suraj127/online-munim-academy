...
const VIDEOS: Video[] = [
  ...
  {
    id: 21,
    title: "POS Billing Quick Sale Checkout",
    description: "How to draft a retail bill in under 15 seconds.",
    category: "Billing",
  ...
  {
    id: 22,
    title: "Gold Schemes Monthly Ledger Entry",
    description: "Record saving schemes installments on customer cards.",
    category: "Scheme / Kitty",
  ...
  {
    id: 23,
    title: "HUID Hallmark Verification Process",
    description: "Quickly verify 6-digit Hallmark codes directly on tax invoices.",
    category: "Hallmark",
  ...
  {
    id: 24,
    title: "Girvi Interest & Loan Setup Guide",
    description: "Setup pawn interest schedules for money lending accounts.",
    category: "Gold Loan / Girvi",
  ...
  {
    id: 25,
    title: "Printer Calibration for Jewelry Barcode Tags",
    description: "Quick setup guide to calibrate barcode printer sensor alignment.",
    category: "Barcode",
  ...
  {
    id: 26,
    title: "Adding Customer Master Record Profile",
    description: "Create profiles, add mobile numbers, and assign credit limits in seconds.",
  ...
  {
    id: 27,
    title: "Google Drive Daily Sync backup check",
    description: "Verify if your cloud automatic scheduler runs correctly.",
    category: "Cloud",
  ...
  {
    id: 28,
    title: "TSC TTP-244 Pro Label Alignment Fix",
    description: "Fix sensor gaps when label dimensions are changed.",
    category: "Barcode",
  ...
  {
    id: 29,
    title: "Adding Stock in Inventory Register",
    description: "Quick walkthrough of weight tag and product master setup.",
    category: "Inventory",
  ...
  {
    id: 30,
    title: "Chit Fund (Kitty Scheme) Collection Setup",
    description: "Organize gold saving schemes and calculate collections.",
    category: "Scheme / Kitty",
  ...
  {
    id: 31,
    title: "Multiple Node Database Network Link Setup",
    description: "Connecting client nodes to the master server database.",
  ...
  {
    id: 32,
    title: "Gold Loan Collateral Assessment",
    description: "Verify gold ornaments weight and karat purity during Girvi bookings.",
    category: "Gold Loan / Girvi",
